...
nonisolated public struct Color: Sendable, Hashable {
...
nonisolated public struct ANSIColor: Sendable, Hashable {
...
nonisolated struct XTermColor: Sendable, Hashable {
    let value: Int
...
nonisolated struct TrueColor: Sendable, Hashable {
    let red: Int
    let green: Int
    let blue: Int
}
